...
// Safe distances
const float CHECKPOINT_1 = 16.50; // First stop
const float CHECKPOINT_2 = 18.8;  // Stop for drawing
const float CHECKPOINT_3 = 14.0;  // Third stop
const float CHECKPOINT_4 = 16.5;  // Fourth stop
const float CHECKPOINT_5 = 18.0;  // Fifth stop
...
float S2array[272] = {
  ...
  0.000, -0.013, -0.025, -0.038, -0.051, -0.064, -0.077, -0.091, -0.104, -0.118,
  -0.132, 0
};
...
float S3array[272] = {
  ...
  -1.571, -1.571, -1.571, -1.570, -1.570, -1.570, -1.569, -1.569, -1.568, -1.567,
  -1.567, -1.566, -1.565, -1.564, -1.563, -1.561, -1.560, -1.559, -1.557, -1.556,
  -1.554, -1.552, -1.551, -1.549, -1.547, -1.545, -1.543, -1.540, -1.538, -1.536,
  -1.533, -1.531, -1.528, -1.525, -1.523, -1.520, -1.517, -1.514, -1.511, -1.507,
  -1.504, -1.501, -1.497, -1.494, -1.490, -1.486, -1.483, -1.479, -1.475, -1.471,
  -1.466, -1.462, -1.458, -1.453, -1.449, -1.444, -1.440, -1.435, -1.430, -1.425,
  -1.420, -1.415, -1.410, -1.405, -1.399, -1.394, -1.388, -1.383, -1.377, -1.371,
  -1.365, -1.359, -1.353, -1.347, -1.341, -1.334, -1.328, -1.321, -1.314, -1.308,
  -1.301, -1.294, -1.287, -1.280, -1.272, -1.265, -1.258, -1.250, -1.242, -1.234,
  -1.227, -1.219, -1.210, -1.202, -1.194, -1.185, -1.177, -1.168, -1.159, -1.150,
  -1.141, -1.132, -1.122, -1.113, -1.103, -1.094, -1.084, -1.074, -1.063, -1.053,
  -1.042, -1.032, -1.021, -1.010, -0.999, -0.987, -0.976, -0.964, -0.952, -0.940,
  -0.927, -0.915, -0.902, -0.889, -0.875, -0.862, -0.848, -0.834, -0.819, -0.805,
  -0.790, -1.57
};
...
void loop() {
  ...
  moveForward(85);
  delay(2000); // Stop for 2 seconds just after passing the gate
  stopMotors();
  delay(2500);

  moveServo(S2, 1422, S2array[0]); // Raise arm to drawing position
  moveServo(S3, 1434, S3array[0]);
  delay(2000);
